    ...
    this.loggedInUser$ = this.authService.currentUser$;
     if (this.type === 'created') {
      ...
      this.subscription = this.communityService
        .getList('/communities/created')
        .subscribe(
          (communities) =>
            (this.communities = communities.sort(function (a, b) {
      ...
      this.subscription = this.communityService
      .getList('/communities').subscribe((communities) => (this.communities = communities
            .sort(function (a, b) {
              return a.creationDate > b.creationDate
                ? -1
                : a.creationDate > b.creationDate
